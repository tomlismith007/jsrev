...
> lineage: 源自 trace/references/captcha/yidun-workflow.md，2026-08-30 平移至 jsrev skill verticals/captcha/。
>
> **外部引用标注**：文中引用的案例文件（如 `1.请求测试.py`、`2.获取cb值.js`、`4.获取data参数.js`、`6.网易易盾.py` 等）属外部参考项目，**不随包发布**；本文只保留协议流程与参数结论。
