...
> lineage: 源自 trace/references/captcha/tencent-edgeone-tdc-workflow.md，2026-08-30 平移至 jsrev skill verticals/captcha/。
...
multi-layer protection belongs to the jsrev core workflow (SKILL.md §4 Core
Loop); locating an unknown TDC entry or browser call stack belongs to the
browser evidence/capture stage with the current browser reverse tools.
