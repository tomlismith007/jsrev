...
> lineage: 源自 trace/references/captcha/tianyu360-workflow.md，2026-08-30 平移至 jsrev skill verticals/captcha/。
>
> **外部引用标注**：文中引用的案例文件（如 `360天御.py`、`rsa_1.js`、`提问1/2/3.txt` 等）属外部参考项目，**不随包发布**；本文只保留协议流程与参数结论。
